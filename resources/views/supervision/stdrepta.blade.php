            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $loop->first ? 'active' : '' }}" id="tab-{{ $item->student_id }}"
                        data-id="{{ $item->student_id }}" onclick="tabclick({{ $item->student_id }})" data-toggle="tab"
                        href="#tabContent-{{ $item->student_id }}" role="tab"
                        aria-controls="tabContent-{{ $item->student_id }}"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" onclick="closeModel()" class="btn btn-secondary"
